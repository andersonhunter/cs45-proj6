...
main( int argc, char *argv[ ] )
{
	...
	cl_mem dX      = clCreateBuffer( Context, CL_MEM_READ_ONLY, DATASIZE, NULL, &status );
	cl_mem dY      = clCreateBuffer( Context, CL_MEM_READ_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumx4  = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumx3  = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumx2  = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumx   = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumx2y = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumxy  = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
	cl_mem dSumy   = clCreateBuffer( Context, CL_MEM_WRITE_ONLY, DATASIZE, NULL, &status );
